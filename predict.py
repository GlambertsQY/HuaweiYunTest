...
def yolo_eval(cfg):
    ...
    for data in ds.create_dict_iterator(output_numpy=True):
        ...
        image_file = image_file.tostring().decode('utf-32')  # Unicode
...
context.set_context(mode=context.GRAPH_MODE, device_target="GPU", device_id=cfg.device_id)

ckpt_path = './ckpt/'
# if not os.path.exists(ckpt_path):
#     mox.file.copy_parallel(src_url=args_opt.ckpt_url, dst_url=ckpt_path)
cfg.ckpt_path = os.path.join(ckpt_path, "yolov3-60_62.ckpt")
